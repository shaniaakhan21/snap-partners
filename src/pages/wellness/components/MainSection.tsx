        ...
        <div className='some-black-over'>
          <div className="content flex flex-col md:flex-row px-4 pt-20 lg:px-20 2xl:px-24 3xl:px-56 mb-2 lg:mb-0">
            <div className='flex flex-col md:w-5/6 lg:8/12 xl:9/12 2xl:w-10/12 pr-right'>
              <div>
                <h1 className='text-black text-lg md:text-2xl lg:text-3xl xl:text-3xl 2xl:text-5xl 3xl:text-8xl font-medium text-center md:text-left'>Welcome to a healthier you with <br></br> <span className='font-bold-it'>SNAP<span className='text-red-h'> Wellness</span></span></h1>
                <p className='text-black text-xs md:text-base lg:text-lg xl:text-xl 2xl:text-xl 3xl:text-4xl pt-4 font-medium text-center md:text-left'>Take charge of your overall wellness with organic, high-quality wellness products backed by science that will be sure to make an impact in your everyday life.</p>
              </div>
