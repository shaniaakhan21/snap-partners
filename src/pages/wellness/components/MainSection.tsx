  ...
  return (
    <div>
      <div className="video-container w-full md:h-50vh xl:h-75vh">
        ...
        <div className="content flex flex-col md:flex-row mt-4 md:mt-20 xl:mt-12 2xl:mt-19 3xl:mt-32 px-4 pt-4 lg:pt-0 lg:px-20 2xl:px-36 3xl:px-56 mb-2 lg:mb-0">
          <div className='flex flex-col md:w-5/6 lg:8/12 xl:9/12 2xl:w-10/12 pr-right'>
            <div>
              <h1 className='text-white text-lg md:text-2xl lg:text-3xl xl:text-3xl 2xl:text-4xl 3xl:text-8xl font-light text-center md:text-left'>Welcome to a healthier you with <br></br> <span className='font-bold-it'>SNAP<span className='text-red-h'> Wellness</span></span></h1>
            ...
            <div className='pt-4 lg:pt-10 text-center md:text-left'>
              <Button
                classes='text-xs md:text-base lg:text-lg xl:text-lg 2xl:text-base 3xl:text-4xl bg-btn-color rounded-lg px-2 lg:px-7 2xl:px-5 3xl:px-10 2xl:py-3 3xl:py-5'
