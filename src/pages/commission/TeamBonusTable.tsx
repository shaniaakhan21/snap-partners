...
const columns = [
  ...
  { field: 'total', headerName: 'Total', width: 110, headerClassName: 'datagrid-header text-slate-800 bg-lime-200 border-r-2 border-black', flex: 0.5, renderCell: (params) => <div className='w-full h-full bg-lime-200 p-0 m-0 mt-0 flex flex-col justify-center align-center border-r-2 border-black text-slate-800 font-bold'>{params.value}</div> },
