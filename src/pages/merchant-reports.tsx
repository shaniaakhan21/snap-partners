...
const ComingSoon: PageNext = () => {
  ...
  const columns = [
    { field: 'orders', headerName: 'Orders', headerClassName: 'mui-table-bg-header', minWidth: 130, flex: 1 },
    { field: 'amountSpent', headerName: 'Total Sales', headerClassName: 'mui-table-bg-header', minWidth: 130, flex: 1 }
  ]
  ...
  const columns2 = [
    ...
    { field: 'spending', headerName: 'Order Amount', headerClassName: 'mui-table-bg-header', minWidth: 130, flex: 1 },
  ...
  return (
    <>
      <span className='text-2xl font-bold'>Merchant Reports</span> <br /><br />
        ...
        : <>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="col-span-1">
              <h1 style={{ fontWeight: 'bold' }}>Total sales on my team</h1>
              <br/>
