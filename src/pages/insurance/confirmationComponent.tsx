    ...
    <>
      <div className='flex flex-col-reverse lg:flex-row'>
        ...
        <div className='w-[95%] lg:w-[35%] m-4 mt-4 md:mt-16 xl:mt-40 relative right-0 lg:right-[10%] lg:right-[12%] xl:right-[7%]'>
          <h1 className='text-blackCustom font-bold text-lg lg:text-2xl 2xl:text-4xl leading-snug mb-0 xl:mb-10'>
          ...
          <div className="pl-0 lg:pl-40 pr-0 lg:pr-6">
            ...
            <br></br>
            <Button variant="contained" className="send-button bg-customred rounded-xl w-[95%] sm:w-full capitalize py-4 text-base" onClick={onGoBack}>
