...
const ComingSoon: PageNext = () => {
  ...
  const columns = [
    ...
    { field: 'amountSpent', headerName: 'Amount Spent', headerClassName: 'mui-table-bg-header', minWidth: 130, flex: 1 }
  ]
  ...
  const columns2 = [
    ...
    { field: 'spending', headerName: 'Spending', headerClassName: 'mui-table-bg-header', minWidth: 130, flex: 1 },
