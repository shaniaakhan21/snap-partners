  ...
  return (
    <div className='overflow-x-hidden'>
      ...
      <div className='bg-cover bg-center' style={{ backgroundImage: 'url(\'/static/wellness/bg-integrous.jpeg\')' }}>
        ...
        { isIntegrous !== null && (<IntegrousProducts userId={userData?.id || 0} isLoggedIn={isLoggedIn} isGuest={isGuest} referralCode={referralCode} userRole={userData?.roles.ibo} collectionIdAllProducts={isIntegrous ? 447611863342 : 446876746030}/>
        )}
