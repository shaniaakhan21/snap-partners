export const glosaryData = {
  ...
  roles: [
    ...
    {
      icon: '/static/glosary/agent.png',
      title: 'Agent',
      subtitle: 'Snap Financial Agent'
    }
  ],
  ...
  ranks: [
    {
      icons: [
        ...
        '/static/badges/FreeMemberAgent.png'
      ],
      title: 'Free Member',
    ...
    },
    {
      icons: [
        ...
        '/static/badges/ManagerAgent.png'
      ],
      title: 'Manager',
    ...
    },
    {
      icons: [
        ...
        '/static/badges/SupervisorAgent.png'
      ],
      title: 'Supervisor',
    ...
    },
    {
      icons: [
        ...
        '/static/badges/DirectorAgent.png'
      ],
      title: 'Director',
    ...
    },
    {
      icons: [
        ...
        '/static/badges/ExecutiveAgent.png'
      ],
      title: 'Excecutive',
