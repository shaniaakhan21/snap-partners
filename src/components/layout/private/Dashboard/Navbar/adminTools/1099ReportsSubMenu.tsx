    ...
    <>
      {isVisible && (
        <ul className='admin-tool-sub-container right-[101%]'>
          <Link href='' passHref><li className='item-0 sub-list-items font-xs sm:font-base'
            style={{ cursor: 'pointer' }}>Individual</li></Link>
          <Link href='/1099-business-report-export' passHref><li className='item-1 sub-list-items font-xs sm:font-base'
