    ...
    <section className='w-full md:w-1/2 bg-white px-4 py-10 relative h-screen hidden lg:block'>
      <div className='absolute top-10 right-4'>
        <Link href='/auth/login'>
          <a className='text-lg font-bold text-gray-700 uppercase hover:text-primary-500'>{t('desktop.login')}</a>
        </Link>
      </div>

      <div className='leading-8 h-screen flex justify-center items-center -mt-10'>
        <div>
          <span className='text-5xl font-bold text-gray-700'>{t('desktop.title')}</span> <br />
          <span className='text-3xl font-bold text-gray-700'>{t('desktop.subtitle-1')}</span> <br />
          <span className='text-xl font-bold text-gray-600'>{t('desktop.subtitle-2')}</span> <br /><br />
