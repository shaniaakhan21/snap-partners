  ...
  return (
    <li className='mb-4 last:mb-0'>
      <button className='w-full h-16 flex items-center justify-between transition-colors lg:px-2 hover:bg-gray-200' onClick={() => onClick(userId)}>
        ...
        <span style={{ maxWidth: 120 }} className='bg-primary-500 text-sm text-white rounded-3xl font-bold w-1/3 h-10 border border-primary-500 flex items-center justify-center transition-colors hover:bg-hoverPrimary-500'>VIEW MORE</span>
      </button>
    </li>
  )
}
