...
export const ComingSoonPage = () => (
  <div className="flex flex-col h-full bg-center bg-cover bg-no-repeat bg-gray-100">
		<div className="grid place-items-center max-w-3xl w-full mx-auto p-10 my-20 sm:my-auto bg-white-600 border-4 border-primary-500 bg-opacity-70 rounded-xl shadow-2xl space-y-5 text-center">
